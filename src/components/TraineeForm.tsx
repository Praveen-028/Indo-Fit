...
export const TraineeForm: React.FC<TraineeFormProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-gradient-to-br from-ivory-100 to-ivory-50 rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-green-800 to-green-700 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h2 className="text-xl font-bold text-white">Add New Trainee</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-green-200 rounded-lg focus:border-green-500 focus:ring-0 transition-colors"
          ...
          <div className="flex items-center justify-between mt-8">
            {step === 2 && (
              <button
                onClick={() => setStep(1)}
                className="flex items-center space-x-2 px-4 py-2 text-green-700 hover:bg-green-100 rounded-lg transition-colors"
              >
            ...
            {step === 1 ? (
              <button
                ...
                className="ml-auto flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
                <span>Next</span>
              ...
              <button
                ...
                disabled={loading}
                className="ml-auto px-6 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white rounded-lg hover:from-yellow-600 hover:to-yellow-700 disabled:opacity-50 transition-all"
              >
